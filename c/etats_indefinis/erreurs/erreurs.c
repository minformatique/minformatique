...
int main(int argc, char const *argv[]) {
  ...
  */
  ...
  rend les état indéfinis particulièrement difficiles à gérer dans certains cas,
  car ils ont tendance à créer des bugs aléatoires (les meilleurs types de bugs,
  ...
  */
  ...
  voir la sortie s'affichier correctement, mais si vous redirigez l'output vers
