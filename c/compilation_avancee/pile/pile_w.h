...
__declspec(dllexport) extern int new_pile(struct Pile *instance);
...
*/
__declspec(dllexport) extern int pile_append(struct Pile *instance, void **element);
...
valeur.
*/
__declspec(dllexport) extern int pile_pop(struct Pile *instance, void **element);

/*
Libère l'espace mémoire alloué à la pile, à appeler après avoir fini de
l'utiliser.
*/
__declspec(dllexport) extern int free_pile(struct Pile *instance);
